  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <div className="max-w-6xl w-full mx-auto p-4 md:p-8 space-y-8 flex-grow">
        ...
        {/* Page Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card border border-border border-l-4 border-l-[#7BB5A0] p-6 rounded-xl relative overflow-hidden shadow-sm">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#7BB5A0]/5 rounded-full blur-3xl pointer-events-none"></div>
          
          <div className="space-y-2 flex-grow">
            <div className="flex flex-wrap items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#EEF6F3] border border-[#B0D4C8] flex items-center justify-center text-[#3D6E61] shrink-0">
          ...
          <div className="flex items-center gap-3 self-stretch md:self-auto justify-between border-t border-border md:border-none pt-4 md:pt-0">
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-background border border-border font-mono shrink-0">
              <span className="w-2 h-2 rounded-full bg-[#7BB5A0] animate-ping shrink-0" />
              <span className="text-[10px] font-bold text-[#3D6E61] uppercase tracking-widest">
                RATES ENGINE LIVE
              </span>
            </div>
          </div>
