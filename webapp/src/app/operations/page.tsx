  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
        ...
        <div className="bg-[#FDF8EE] border-b border-[#E6C573]/50 px-4 py-3 text-center sticky top-0 z-50">
          <div className="max-w-6xl mx-auto flex items-center justify-center gap-3">
            ...
            <p className="text-xs md:text-sm font-semibold text-[#8A6F2E] flex items-center gap-2">
              ...
              Demo Mode Active — Supabase offline. Operating with local memory database.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="max-w-6xl w-full mx-auto p-4 md:p-8 space-y-8 flex-grow">
        ...
        {/* Page Header */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card border border-border border-l-4 border-l-[#E8A99A] p-6 rounded-xl relative overflow-hidden shadow-sm">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#E8A99A]/5 rounded-full blur-3xl pointer-events-none"></div>
          
          <div className="space-y-2 flex-grow">
            <div className="flex flex-wrap items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#FDF1EE] border border-[#F0C5BC] flex items-center justify-center text-[#8B4E43] shrink-0">
          ...
          <div className="flex items-center gap-3 self-stretch md:self-auto justify-between border-t border-border md:border-none pt-4 md:pt-0">
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-background border border-border font-mono shrink-0">
              <span className="w-2 h-2 rounded-full bg-[#E8A99A] animate-ping shrink-0" />
              <span className="text-[10px] font-bold text-[#8B4E43] uppercase tracking-widest">
                MIAMI: {new Date().toLocaleTimeString('en-US', { hour12: false, hour: '2-digit', minute: '2-digit', timeZone: 'America/New_York' })} EST
              </span>
            </div>
