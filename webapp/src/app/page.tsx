    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-slate-100 flex flex-col font-sans selection:bg-yellow-500/30 selection:text-yellow-300">
      ...
      {isDemoMode && (
        <div className="bg-gradient-to-r from-amber-500/10 via-amber-500/20 to-amber-500/10 border-b border-amber-500/30 px-4 py-3 text-center backdrop-blur-md sticky top-0 z-50 animate-fade-in">
          <div className="max-w-6xl mx-auto flex items-center justify-center gap-3">
            ...
            <p className="text-xs md:text-sm font-semibold tracking-wide text-amber-650 dark:text-amber-300 flex items-center gap-2 font-mono">
      ...
      <div className="max-w-6xl w-full mx-auto p-4 md:p-8 space-y-12 flex-grow flex flex-col justify-center">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-yellow-500/10 border border-yellow-500/25 text-yellow-600 dark:text-yellow-500 text-xs font-mono font-black uppercase tracking-widest animate-pulse">
            <Cpu className="w-4 h-4 shrink-0" />
            WCS Control Hub Middleware
          </div>
          <h1 className="text-4xl md:text-5xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-slate-900 to-slate-500 dark:from-white dark:to-slate-400 font-mono uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          ...
          <div className="group bg-white dark:bg-[#0a0a0c] border border-slate-200 dark:border-slate-900 rounded-2xl overflow-hidden hover:border-yellow-500/30 hover:shadow-2xl hover:shadow-yellow-500/5 transition-all duration-300 flex flex-col relative h-[380px]">
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="space-y-1 mb-4">
                <span className="text-[10px] font-mono text-yellow-600 dark:text-yellow-500 font-bold uppercase tracking-widest">Active Dispatch Board</span>
                <h2 className="text-xl font-black text-slate-800 dark:text-white font-mono uppercase">Operations Terminal</h2>
              </div>
              ...
              {/* KPI Summaries list */}
              <div className="flex-grow space-y-2 border-t border-slate-100 dark:border-slate-900 pt-4 text-[11px] font-mono font-semibold text-slate-500">
                <div className="flex justify-between items-center">
                  <span>Active Shipments:</span>
                  <span className="text-yellow-600 dark:text-yellow-500 font-bold">{activeShipments.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Split Sub-parts:</span>
                  <span className="text-indigo-600 dark:text-indigo-400 font-bold">{totalSubfiles}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Today Arrivals/Departures:</span>
                  {todayAlertsCount > 0 ? (
                    <span className="bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-900/50 px-2 py-0.5 rounded font-black text-[10px] animate-pulse">
          ...
          {/* CARD 2: TASK TRACKER */}
          <div className="group bg-white dark:bg-[#0a0a0c] border border-slate-200 dark:border-slate-900 rounded-2xl overflow-hidden hover:border-indigo-500/30 hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-300 flex flex-col relative h-[380px]">
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="space-y-1 mb-4">
                <span className="text-[10px] font-mono text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-widest">Workflow Management</span>
                <h2 className="text-xl font-black text-slate-800 dark:text-white font-mono uppercase">Tasks Tracker</h2>
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-6">
              ...
              <div className="flex-grow space-y-2 border-t border-slate-100 dark:border-slate-900 pt-4 text-[11px] font-mono font-semibold text-slate-500">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-indigo-600 dark:text-indigo-400 font-bold">{pendingTasks.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Completed Tasks:</span>
                  <span className="text-emerald-600 dark:text-emerald-500 font-bold">{completedTasks.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Due Today / Overdue:</span>
                  {tasksDueToday > 0 ? (
                    <span className="bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-450 border border-rose-200 dark:border-rose-900/50 px-2 py-0.5 rounded font-black text-[10px] animate-pulse animate-bounce">
          ...
          <div className="group bg-white dark:bg-[#0a0a0c] border border-slate-200 dark:border-slate-900 rounded-2xl overflow-hidden hover:border-emerald-500/30 hover:shadow-2xl hover:shadow-emerald-500/5 transition-all duration-300 flex flex-col relative h-[380px]">
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="space-y-1 mb-4">
                <span className="text-[10px] font-mono text-emerald-600 dark:text-emerald-450 font-bold uppercase tracking-widest">Base costs & catalogs</span>
                <h2 className="text-xl font-black text-slate-800 dark:text-white font-mono uppercase">Ratesheet Tracker</h2>
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed mb-6">
              ...
              <div className="flex-grow space-y-2 border-t border-slate-100 dark:border-slate-900 pt-4 text-[11px] font-mono font-semibold text-slate-500">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-emerald-650 dark:text-emerald-400 font-bold">{totalBaseRates} items</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Client-Specific Sheets:</span>
                  <span className="text-slate-700 dark:text-slate-350 font-bold">{clientRatesheetsCount} sheets</span>
                </div>
                <div className="flex justify-between items-center">
                  <span>Mass Markup Tool:</span>
                  <span className="text-slate-500 dark:text-slate-600 font-bold uppercase tracking-widest text-[9px]">Enabled</span>
                </div>
              </div>
        ...
        <div className="bg-white dark:bg-[#050507] border border-slate-200 dark:border-slate-900 rounded-2xl p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden shadow-md">
          ...
          <div className="space-y-1">
            <h3 className="text-sm font-bold text-slate-800 dark:text-white uppercase tracking-wider flex items-center gap-1.5 font-mono">
          ...
          <Link 
            href="/portal" 
            className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-slate-350 dark:hover:border-slate-700 hover:bg-slate-200/50 dark:hover:bg-slate-800/40 text-sky-655 dark:text-sky-400 hover:text-sky-750 dark:hover:text-sky-300 font-bold rounded-xl text-xs uppercase tracking-wider transition-all shrink-0"
          >
            Open Public Portal
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200 dark:border-slate-950 bg-white dark:bg-black py-8 text-center text-xs text-slate-500 dark:text-slate-600 font-mono tracking-wider uppercase">
